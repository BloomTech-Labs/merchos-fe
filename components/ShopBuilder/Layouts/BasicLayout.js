export const BasicLayout = [
  ...
  },
  {
    ...
    items: [
      ...
      { content: "A", height: "100px" },
      { content: "B", height: "100px" },
      { content: "C", height: "100px" },
      { content: "D", height: "100px" },
      { content: "E", height: "100px" },
      { content: "F", height: "100px" }
    ],
    order: 3,
    rowLimit: 5
  },
  {
    id: "DOUBLE_SIZE_1",
    items: [
      { id: "banner1", content: "Double Size", height: "100px", width: "100%" },
      {
        id: "halfImage1",
  ...
  },
  {
    ...
    items: [
      ...
      { id: "3-0-1", content: "B", height: "100px" },
      { id: "3-0-2", content: "C", height: "100px" },
      { id: "3-1-3", content: "D", height: "100px" },
      { id: "3-1-4", content: "E", height: "100px" },
      { id: "3-1-5", content: "F", height: "100px" }
    ],
    order: 3,
    rowLimit: 4
  }
